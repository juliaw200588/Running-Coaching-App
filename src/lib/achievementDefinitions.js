...
const MOMENTS = [
  { id: 'moment_early_bird', version: 1, sport: 'all', category: 'moments', metric: 'start_before_hour', threshold: 6, icon: '🌅', visibility: 'secret', tier: 1, title: 'Frühaufsteher', description: 'Eine Aktivität vor 06:00 Uhr.' },
  { id: 'moment_night_owl', version: 1, sport: 'all', category: 'moments', metric: 'start_after_hour', threshold: 21, icon: '🌙', visibility: 'secret', tier: 1, title: 'Nachteule', description: 'Eine Aktivität nach 21:00 Uhr.' },
  { id: 'moment_new_year', version: 1, sport: 'all', category: 'moments', metric: 'calendar_date', threshold: '01-01', icon: '🎆', visibility: 'secret', tier: 1, title: 'Neujahrsaktivität', description: 'Das neue Jahr sportlich begonnen.' },
  { id: 'moment_christmas', version: 1, sport: 'all', category: 'moments', metric: 'calendar_date', threshold: '12-25', icon: '🎄', visibility: 'secret', tier: 1, title: 'Weihnachtsaktivität', description: 'Auch an Weihnachten aktiv geblieben.' },
  { id: 'moment_four_seasons', version: 1, sport: 'all', category: 'moments', metric: 'four_seasons', threshold: 4, icon: '🍂', visibility: 'hinted', tier: 1, title: 'Vier Jahreszeiten', description: 'In allen vier Jahreszeiten aktiv gewesen.' },
]
