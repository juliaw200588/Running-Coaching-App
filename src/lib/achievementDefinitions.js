...
export const ACHIEVEMENT_CATEGORIES = {
  ...
  experiences: { id: 'experiences', label: 'Erlebnisse', icon: '🌍' },
...
const EXPERIENCES = [
  // Wetter – sichtbar
  {
    ...
    metric: 'context_tag',
    threshold: 'sun',
    contextGroup: 'weather',
    icon: '☀️',
    visibility: 'visible',
    rarity: 'common',
    tier: 1,
    title: 'Sonnenmoment',
    description: 'Eine Aktivität bei sonnigen Bedingungen.',
    story: 'Sonne im Gesicht, Bewegung im Körper – manchmal braucht es nicht mehr.',
  },
  {
    id: 'experience_rain',
    version: 1,
    ...
    tier: 1,
    title: 'Regenfest',
    description: 'Eine Aktivität im Regen.',
    story: 'Andere warten auf besseres Wetter. Du hast einfach angefangen.',
  },
  {
    id: 'experience_wind',
    version: 1,
    ...
    description: 'Eine Aktivität bei deutlich windigen Bedingungen.',
    story: 'Der Wind war Teil der Strecke – und du bist trotzdem weiter.',
  },

  // Wetter – angedeutet / selten
  {
    id: 'experience_snow',
    version: 1,
    sport: 'all',
    ...
    tier: 1,
    title: 'Wintermoment',
    description: 'Eine Aktivität bei Schnee.',
    story: 'Kalte Luft, leise Wege und Bewegung mitten im Winter.',
  },
  {
    id: 'experience_fog',
    version: 1,
    ...
    tier: 1,
    title: 'Im Nebel',
    description: 'Eine Aktivität bei nebligen Bedingungen.',
    story: 'Der Weg verschwindet im Grau – dein Rhythmus bleibt.',
  },

  // Natur – sichtbar
  {
    id: 'experience_forest',
    version: 1,
    sport: 'all',
    category: 'experiences',
    metric: 'context_tag',
    threshold: 'forest',
    contextGroup: 'environment',
    icon: '🌲',
    visibility: 'visible',
    rarity: 'common',
    tier: 1,
    title: 'Waldzeit',
    description: 'Eine Aktivität im Wald.',
    story: 'Zwischen Bäumen fühlt sich Bewegung manchmal ein bisschen leichter an.',
  },
  {
    id: 'experience_coast',
    version: 1,
    ...
    tier: 1,
    title: 'Küstenkind',
    description: 'Eine Aktivität an der Küste.',
    story: 'Salz in der Luft, Weite vor dir – ein Weg mit Horizont.',
  },
  {
    id: 'experience_mountain',
    version: 1,
    sport: 'all',
    category: 'experiences',
    metric: 'context_tag',
    ...
    tier: 1,
    title: 'Bergluft',
    description: 'Eine Aktivität in deutlich bergiger Umgebung.',
    story: 'Wo der Weg nach oben führt, fühlt sich jeder Meter anders an.',
  },
  {
    id: 'experience_field',
    version: 1,
    ...
    tier: 1,
    title: 'Weite Wege',
    description: 'Eine Aktivität durch Feld- oder Wiesenlandschaft.',
    story: 'Offene Wege, weiter Blick – manchmal liegt Freiheit direkt vor der Haustür.',
  },
  {
    id: 'experience_beach',
    version: 1,
    ...
    tier: 1,
    title: 'Am Strand',
    description: 'Eine Aktivität am Strand.',
    story: 'Sand unter den Füßen oder Reifen – und das Meer ganz nah.',
  },

  // Licht / Tagesphase
  {
    id: 'experience_sunrise',
    version: 1,
    sport: 'all',
    category: 'experiences',
    metric: 'context_tag',
    ...
    rarity: 'rare',
    tier: 1,
    title: 'Mit der Sonne gestartet',
    description: 'Eine Aktivität rund um den Sonnenaufgang.',
    story: 'Der Tag beginnt – und du bist schon mittendrin.',
  },
  {
    id: 'experience_sunset',
    version: 1,
    sport: 'all',
    category: 'experiences',
    metric: 'context_tag',
    ...
    rarity: 'rare',
    tier: 1,
    title: 'Goldener Ausklang',
    description: 'Eine Aktivität rund um den Sonnenuntergang.',
    story: 'Noch ein paar Kilometer, während der Tag langsam leiser wird.',
  },

  // Verborgene Kombinationen – echte Überraschungen
  {
    id: 'experience_combo_rain_forest',
    version: 1,
    sport: 'all',
    category: 'experiences',
    metric: 'context_combo',
    threshold: ['rain', 'forest'],
    icon: '🌧️',
    visibility: 'secret',
    rarity: 'rare',
    tier: 1,
    title: 'Wald im Regen',
    description: 'Regen und Wald in derselben Aktivität erlebt.',
    story: 'Nasses Grün, leise Wege und du mittendrin.',
  },
  {
    id: 'experience_combo_sunrise_coast',
    version: 1,
    sport: 'all',
    category: 'experiences',
    metric: 'context_combo',
    threshold: ['sunrise', 'coast'],
    icon: '🌅',
    visibility: 'secret',
    rarity: 'epic',
    tier: 1,
    title: 'Morgen am Meer',
    description: 'Sonnenaufgang und Küste in derselben Aktivität erlebt.',
    story: 'Der Horizont wird hell, das Meer liegt neben dir – ein Moment, der bleibt.',
  },
  {
    id: 'experience_combo_sun_mountain',
    version: 1,
    sport: 'all',
    category: 'experiences',
    metric: 'context_combo',
    threshold: ['sun', 'mountain'],
    icon: '⛰️',
    visibility: 'secret',
    rarity: 'rare',
    tier: 1,
    title: 'Sonnige Höhen',
    description: 'Sonne und Berge in derselben Aktivität erlebt.',
    story: 'Klare Luft, Licht auf den Höhen – dafür lohnt sich jeder Anstieg.',
  },
  {
    id: 'experience_combo_snow_mountain',
    version: 1,
    sport: 'all',
    category: 'experiences',
    metric: 'context_combo',
    threshold: ['snow', 'mountain'],
    icon: '❄️',
    visibility: 'secret',
    rarity: 'epic',
    tier: 1,
    title: 'Winter in den Bergen',
    description: 'Schnee und Berge in derselben Aktivität erlebt.',
    story: 'Weiß, kalt, still – und ganz sicher kein gewöhnlicher Trainingstag.',
  },
]
